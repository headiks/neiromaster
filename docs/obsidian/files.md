...
## `users.py`
Профили и роли (владелец/админ/сотрудник). Создание карточек, регистрация сотрудника,
назначение плана, смена ролей, передача владения, миграция из legacy employees.json.
